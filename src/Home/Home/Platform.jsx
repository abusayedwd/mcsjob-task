             ...
             <p>We are more than a platform;  We are your <br /> success partner. Discover our services to achieve <br /> your business and educational goals</p>
                     ...
                     <div className="grid md:grid-cols-2 md:gap-4 mt-6">
                           ...
                           <div className='flex items-center gap-2 justify-around'>
                              <img src={connect} alt="" /> 
                              <p><span className='font-bold'>CONNECTIONS</span> with the resources to meet your business needs</p>
                           </div>
                           <div className='flex items-center gap-2 justify-around'>
                              <img src={refresh} alt="" /> 
                              <p><span className='font-bold'>REFRESH</span> and generate reports that drive growth</p>
                           </div>
                           <div className='flex items-center gap-2 justify-around'>
                              <img src={academy} alt="" /> 
               ...
               <div className='md:w-[50%]'>
                     <div className="flex items-center justify-evenly">
                        <div className='text-right'> 
                           ...
                           <p className='bg-slate-200 rounded-md text-sm mt-4 p-1'>I learned from their videos, got my first job.</p>
                        </div>
                        <div><img className='h-48' src={manpic} alt="" /></div>
                     </div>
                     <div className="flex items-center justify-evenly">
                        <div><img className='h-48 rounded-3xl' src={womenpic} alt="" /></div>
                        <div> 
                        <p className='bg-slate-200 p-1 rounded-md text-sm'>I got a perfect analysis report from them too</p>
                        <p className='bg-slate-200 w-28 rounded-md text-sm mt-4 p-1'>Oh, that is great.</p>
                        </div>
                     </div>
               </div>
             </div>
